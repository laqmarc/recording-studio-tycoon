// esm/ui_render.mjs - ESM version of the UI renderer
import { state, installedIds } from '../state.js';
import { euro, xpToNext, invQty } from './helpers.mjs';
import { getContractETA as getContractETA_impl, workOnContract as workOnContract_impl } from './actions.mjs';
