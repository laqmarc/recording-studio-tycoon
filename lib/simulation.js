// lib/simulation.js - testable simulation that doesn't rely on globals
const { clamp, avgStat, sumStat } = require('./helpers');
...
function simulateRecording(state, roomIndex, contract) {
...
module.exports = { simulateRecording };
